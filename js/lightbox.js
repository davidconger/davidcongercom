...
Lightbox.prototype = {
    ...
    start: function(imageLink) {    
        ...
        if ((imageLink.rel == 'lightbox')){
            ...
            this.imageArray.push([imageLink.href, imageLink.title, imageLink.additionalLinks]);         
        } else {
    ...
    updateDetails: function() {
        ...
        if (this.imageArray[this.activeImage][1] != ""){
            this.caption.update(this.imageArray[this.activeImage][1] + this.imageArray[this.activeImage][2]).show();
        }
